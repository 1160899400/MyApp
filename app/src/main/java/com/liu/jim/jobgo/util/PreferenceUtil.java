...
public final class PreferenceUtil {
    private static final String DEFAULT_NAME = "job_go_preference";
    private static SimpleArrayMap<String, PreferenceUtil> SP_UTILS_MAP = new SimpleArrayMap<>();
     ...
     * @return {@link PreferenceUtil}
     */
    public static PreferenceUtil getInstance(String spName) {
        if (isSpace(spName)) {
            spName = DEFAULT_NAME;
        }
        PreferenceUtil spUtils = SP_UTILS_MAP.get(spName);
        if (spUtils == null) {
            synchronized (PreferenceUtil.class) {
                spUtils = SP_UTILS_MAP.get(spName);
                if (spUtils == null) {
                    spUtils = new PreferenceUtil(spName);
